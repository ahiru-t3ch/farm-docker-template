    ...
    return (
        <section id="home" className="h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-green-500 text-white">
            <div className="text-center">
                ...
                <p className="text-lg">Get project code on GitHub: <a href="https://github.com/ahiru-t3ch/farm-docker-template" target="_blank" rel="noopener" class="font-bold hover:underline">farm-docker-template</a>.</p>
            </div>
        </section>
    )
}